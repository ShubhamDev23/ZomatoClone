  ...
  return (
    <div className='signup-container'>
      <div className='sub-container'>
        ...
        <h2 className='log-up-heading'>Sign-up</h2>
       <Link to="/"> <img 
      ...
      />
      <button className='create-btn' onClick={createuser}>Create account</button>
      ...
      <button className='google-btn'>
        ...
        <div className='lastline'>Already have an account?
        <Link className='linklast' to="/login">Login</Link>
        </div>
      </div>
    </div>
  )
