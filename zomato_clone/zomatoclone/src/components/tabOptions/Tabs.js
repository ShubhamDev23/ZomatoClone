...
const Tabs = ({activetab,setactivetab}) => {
  return (  
    <div className='tab-options '>
      <div className='my_width option-wraper'>
        {tabs.map((tab)=>{
          return <div key={tab.id} name={tab.name} onClick={()=>setactivetab(tab.name)}
          className={`tab-item absolute-centre curser ${activetab===tab.name && 'active-tab'}`} 
          >
            <div className='tab-imge-container absolute-center food-option'
            style={{
              backgroundColor:`${
